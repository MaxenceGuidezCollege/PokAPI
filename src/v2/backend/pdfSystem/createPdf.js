...
const getDocDefinition = require("./docDefinition.js");

const fontDescriptors = {
    Roboto: {
        normal: path.join(__dirname, 'fonts/roboto_regular.ttf'),
        bold: path.join(__dirname, 'fonts/roboto_medium.ttf'),
        italics: path.join(__dirname, 'fonts/roboto_italic.ttf'),
        boldItalics: path.join(__dirname, 'fonts/roboto_mediumItalic.ttf')
    }
};
